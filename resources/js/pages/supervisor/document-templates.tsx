    ...
    const handleConfirm = () => {
        ...
        if (confirmAction.type === 'archive') {
            ...
            router.delete(documentTemplates.destroy.url(target.document_type), {
                preserveScroll: true,
                onSuccess: () => {
                    toast.success(`Document "${target.name}" moved to archive.`);
            ...
            const { target } = confirmAction;
            router.post(documentTemplates.restore.url(target.id), {}, {
                preserveScroll: true,
                onSuccess: () => {
                    toast.success(`Document "${target.name}" restored successfully.`);
                    setConfirmAction(null);
                },
                onError: () => {
            ...
            router.delete(documentTemplates.forceDelete.url(target.id), {
                preserveScroll: true,
                onSuccess: () => {
                    toast.success(`Document "${target.name}" permanently deleted.`);
                    setConfirmAction(null);
                },
                onError: () => {
    ...
    return (
        <>
                                ...
                                >
                                    <CardContent className="p-4 space-y-3">
                                        <div className="flex items-start justify-between gap-2">
                                            <div className="flex items-start gap-2.5 min-w-0">
                                                ...
                                                <div className="min-w-0 space-y-0.5">
                                                    <div className="flex flex-wrap items-center gap-1.5">
                                                        ...
                                                        <StatusBadge status={item.required ? 'required' : 'optional'} className="text-[9px] px-1.5 py-0" />
                                                        {item.is_custom && (
                                            ...
                                            <StatusBadge status="archived" className="text-[10px] shrink-0" />
                                        </div>
                                    ...
                                    <div className="border-t border-border/50 px-4 py-2.5 flex items-center justify-end gap-2 bg-muted/20">
                                        <Button
                                            ...
                                            onClick={() => setConfirmAction({ type: 'restore', target: item })}
                                        >
                                        ...
                                        <Button
                                            ...
                                            onClick={() => setConfirmAction({ type: 'force_delete', target: item })}
                                        >
                                ...
                                <Table>
                                    <TableHeader>
                                        <TableRow className="bg-muted/50">
                                            ...
                                            <TableHead className="px-6 text-center">Template File</TableHead>
                                            <TableHead className="px-6 text-center">Archived Date</TableHead>
                                    ...
                                    <TableBody>
                                        {filteredArchived.map((item) => (
                                            <TableRow key={item.id} className="hover:bg-muted/30">
                                                ...
                                                <TableCell className="px-6 text-center text-xs text-muted-foreground font-mono">
                                                    {item.original_filename || <span className="italic">None</span>}
                                                </TableCell>
                                                <TableCell className="px-6 text-center text-xs text-muted-foreground whitespace-nowrap">
                                                    {item.deleted_at}
                                                </TableCell>
                                                <TableCell className="px-6 text-center">
                                ...
                                >
                                    <CardContent className="p-4 space-y-3">
                                        ...
                                        <div className="flex items-start justify-between gap-2">
                                            ...
                                            {/* Status Badge */}
                                            <StatusBadge status={item.has_template ? 'ready' : 'no_template'} className="text-[10px] shrink-0" />
                                        </div>
                                            ...
                                            <Tooltip>
                                                <TooltipTrigger asChild>
                                                    <Button
                                                        ...
                                                        onClick={() => setConfirmAction({ type: 'archive', target: item })}
                                                    >
                                ...
                                <Table>
                                    <TableHeader>
                                        <TableRow className="bg-muted/50">
                                            ...
                                            <TableHead className="px-6 text-center">Format Status</TableHead>
                                            <TableHead className="px-6 text-center">Blank File</TableHead>
                                            <TableHead className="px-6 text-center">Guidance</TableHead>
                                            <TableHead className="px-6 text-center">Actions</TableHead>
                                        </TableRow>
                                    </TableHeader>
                                    <TableBody>
                                        {filteredChecklist.map((item) => (
                                            <TableRow key={item.document_type} className="hover:bg-muted/30">
                                                ...
                                                <TableCell className="px-6 text-center">
                                                    <StatusBadge status={item.has_template ? 'ready' : 'no_template'} />
                                                </TableCell>
                                                    ...
                                                    {item.has_template ? (
                                                        <div className="space-y-0.5 max-w-[180px] mx-auto">
                                                            <div className="font-medium text-foreground flex items-center justify-center gap-1.5 truncate">
                                                                ...
                                                                <span className="truncate" title={item.original_filename || ''}>{item.original_filename}</span>
                                                            </div>
            ...
            <ViewGuidanceDialog
                ...
                programName={program.program_name}
                onEditClick={() => {
                    if (instructionsModalItem) openEditModal(instructionsModalItem);
                }}
            />
