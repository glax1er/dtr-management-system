                ...
                <DialogContent className="max-h-[90vh] overflow-y-auto sm:max-w-[560px]">
                    ...
                    <form onSubmit={handleAddSubmit} className="space-y-4 pt-2">
                        <div className="grid grid-cols-1 gap-3.5 sm:grid-cols-2">
                            {/* Role Selection */}
                            <div className="col-span-1 min-w-0 space-y-1.5 sm:col-span-2">
                            ...
                            {addRole === 'college_admin' ? (
                                ...
                                <div className="col-span-1 rounded-md bg-purple-50 p-3 text-xs text-purple-700 sm:col-span-2 dark:bg-purple-950/40 dark:text-purple-300">
                ...
                <DialogContent className="max-h-[90vh] overflow-y-auto sm:max-w-[560px]">
                    ...
                    >
                        <div className="grid grid-cols-1 gap-3.5 sm:grid-cols-2">
                            ...
                            <div className="col-span-1 border-t pt-2 text-xs text-muted-foreground sm:col-span-2">
